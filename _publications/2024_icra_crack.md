...
citation: 'Yao, Zhen, Jiawei Xu, Shuhang Hou, and Mooi Choo Chuah. "Cracknex: a few-shot low-light crack segmentation model based on retinex theory for uav inspections." ICRA 2024.'
image: '../images/2024_icra_crack.png'
tldr: 'We propose CrackNex, a framework that utilizes reflectance based on Retinex Theory and few-shot strategy to address limited low-light crack training data issue, and present the first benchmark dataset, LCSD, for low-light crack segmentation.'
---
